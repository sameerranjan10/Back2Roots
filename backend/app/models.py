...
class User(Base):
    ...
    role = Column(Enum("student", "alumni", "admin", name="user_roles"), default="student", nullable=False)
    ...
    mentorship_as_student = relationship("MentorshipRequest", foreign_keys="MentorshipRequest.student_id", back_populates="student", cascade="all, delete-orphan")
    mentorship_as_alumni = relationship("MentorshipRequest", foreign_keys="MentorshipRequest.alumni_id", back_populates="alumni", cascade="all, delete-orphan")
...
class MentorshipRequest(Base):
    ...
    status = Column(Enum("pending", "accepted", "rejected", name="mentorship_status"), default="pending", nullable=False)
